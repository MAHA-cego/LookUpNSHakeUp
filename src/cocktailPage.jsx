  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-screen">
        <p className="text-l text-center font-[PPGoshaSans-Regular]">
          Loading...
        </p>
      </div>
    );
  if (error)
    return (
      <div className="flex flex-col gap-10 items-center justify-center h-screen">
        ...
        <button
          className="text-l text-center font-[PPGoshaSans-Regular] p-2 border cursor-pointer"
          onClick={() => navigate("/")}
        >
          Go back
        </button>
    ...
    <div>
      <header className="flex flex-row justify-between sm:grid grid-cols-[3fr_7fr_2fr] grid-rows-1 border-b h-15 sm:h-25 items-center">
        <div className="col-start-1 col-span-1 sm:border-r h-full flex items-center justify-center ml-4">
          <h1 className="font-[PPGoshaSans-Regular] text-2xl sm:tetx-4xl lg:text-5xl 2xl:text-6xl tracking-wider">
            {cocktail.strDrink}
          </h1>
        </div>
        ...
        <div className="col-start-3 col-span-1 border-l h-full flex items-center justify-center">
          <button
            className="font-[PPGoshaSans-Regular] text-l lg:text-xl 2xl:text-2xl tracking-wide
                    h-full w-full cursor-pointer px-5"
            onClick={() => navigate("/")}
          >
            New search
          </button>
